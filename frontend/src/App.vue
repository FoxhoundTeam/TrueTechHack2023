...
export default {
  data(){
    return {
      navigation_model : [
        {title:"Видео", icon:"mdi-multimedia", link:"MainView"},
        {title:"Логин (тест)", icon:"mdi-file", link:"LoginView"},
      ],
      selected_nav_link : 0,
  ...
  mounted() {
    //this.$router.push({name:this.navigation_model[0].link})
  },
